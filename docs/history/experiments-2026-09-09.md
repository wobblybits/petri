> **Not maintained.** The version of `experiments.md` from 2026-09-09, kept for the failure stories and the record of which pond-library sweeps pool with which. `docs/experiments.md` is the live document.
...
- **Turning a mechanism off can take more dials than it has a name.**
  ...
  simulated seconds. Locomotion off is `grip=0 gaitRate=0 transportQuantum=0`,
