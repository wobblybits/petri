...
quietly wrong rather than loudly empty. The learning row
...
| `commutesPerLatch` | the tripwire on internal work vs re-acquiring structure |
...
The chemistry is in, and every one of these ships at the value that reproduces
the pond before it. Turning them on is a sweep, not a default.
