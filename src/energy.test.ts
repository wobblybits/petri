...
describe('harvest slots', () => {
  ...
  it('takes what fits, exactly as before, at uptakeVmax zero', () => {
    ...
    const a2 = body(1, 2, 2);
    harvestSlots([a2], metered, { cap: 0, ks: 0.25, table: false, yDirect: 1, yEra: 1 });
  ...
  it('shares a contested cell instead of handing it to the lowest id', () => {
    ...
    harvestSlots([a, b], grid, { cap: 0.2, ks: 0.25, table: false, yDirect: 1, yEra: 1 });
  ...
  it('caps a rich cell at the rate and a poor one below it', () => {
    ...
    const r = body(1, 2, 2);
    harvestSlots([r], rich, { cap: 0.2, ks: 0.25, table: false, yDirect: 1, yEra: 1 });
    ...
    const p = body(1, 2, 2);
    harvestSlots([p], poor, { cap: 0.2, ks: 0.25, table: false, yDirect: 1, yEra: 1 });
